...
<main class="max-w-7xl mx-auto px-2 xl:px-0">
    ...
    <main class="px-1.5 lg:px-2 pb-2 max-w-7xl mx-auto">
        ...
        <div class="pt-1">
            <a href="main-hall.html"
                class="bg-white bg-opacity-50 py-0.5 lg:py-2 pl-1 lg:pl-2 pr-2 lg:pr-3 font-medium rounded-md text-xs sm:text-sm inline-flex items-center space-x-1 group"
                style="background: rgba( 255, 255, 255, 0.3 );
          box-shadow: 0 8px 32px 0 rgba( 31, 38, 135, 0.37 );
          backdrop-filter: blur( 2.5px );
          -webkit-backdrop-filter: blur( 2.5px );
          border: 1px solid rgba( 255, 255, 255, 0.18 );"><svg class="w-4 group-hover:-translate-x-0.5 transition"
        ...
        <div x-cloak x-show="openChatModal" @keydown.window.escape="openChatModal = false"
            ...
            <div
                class="flex items-end justify-center min-h-screen pb-12 text-center lg:block lg:px-0 lg:py-2 overflow-hidden">
                ...
                border: 1px solid rgba( 255, 255, 255, 0.18 );">
                    ...
                    <div class="grid grid-cols-3 w-full bg-white rounded-md">
                                ...
                                <li class="group cursor-pointer">
                                    <div class="flex space-x-3 px-0 pr-1 sm:px-4 group-hover:bg-gray-100 py-4">
                                        ...
                                        <div class="flex-1 space-y-1">
                                            ...
                                            <p class="text-sm text-gray-500 line-clamp-2">Lorem ipsum dolor sit amet
                                                consectetur,
                                                adipisicing elit.
                                                Doloribus exercitationem libero aspernatur non. Quis, vitae iure quae
                                                reprehenderit
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="col-span-2">
                                ...
                                <ul class="pl-1.5 pr-1 sm:px-4 py-2 w-full flex flex-col space-y-2 items-start">
                                    ...
                                    <li class="group cursor-pointer max-w-[95%] sm:max-w-[60%]">
                                        <div class="flex-1 space-y-0.5 bg-gray-100 rounded-md shadow px-3 py-2">
                                            ...
                                            <p class="text-sm text-gray-700">Lorem ipsum dolor sit amet consectetur,
                                                adipisicing elit.
                            ...
                            <!-- Chat input -->
                            <form id="chat-form" class="px-1.5 sm:px-4 py-2 border-t border-gray-200 bg-gray-100"
                          ...
                          justify-center"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 rotate-45"
    ...
    <div class="board-title rounded-t-md">
        <div class="w-full h-full grid grid-cols-2">
            <div>Exhibitors & Sponsors</div>
            <form class="flex items-center">
                <div class="search-exhibitor-input w-full">
                    <label for="search-exhibitor" class="sr-only">Search Exhibitor</label>
                    <div class="relative">
                        <div style="padding: 2%;"
                            class="hidden sm:flex absolute inset-y-0 items-center pointer-events-none">
                            <svg class="search-exhibitor-input-icon text-gray-400" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                <path fill-rule="evenodd"
                                    d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z"
                                    clip-rule="evenodd" />
                        ...
                        <input id="search-exhibitor" name="search-exhibitor"
                            class="block w-full border border-gray-300 rounded-l-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-[#00B4BF] focus:border-[#00B4BF]"
                            placeholder="Search" type="search">
                    </div>
                </div>
                <button
                    class="search-exhibitor-button bg-[#00B4BF] text-white rounded-r-md text-sm  hover:bg-opacity-80"><svg
    ...
    <div class="board-wrapper">
        <div class="board bg-white bg-opacity-65">
            <!-- Exhibitor List -->
            ...
            <div class="swiper relative h-full">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide pb-6">
                        <div class="grid grid-cols-2 gap-4 p-4 w-full h-full">
                            <a href="virtual-booth-10.html"
                                class="flex justify-center bg-gray-100 hover:shadow-lg cursor-pointer rounded-xl items-center">
                                <img style="width: 60%;" src="assets/ptpi.png" alt="PTPI">
                            </a>
                            <a href="virtual-booth-10.html"
                                class="flex justify-center bg-gray-100 hover:shadow-lg cursor-pointer rounded-xl items-center">
                                <img style="width: 60%;" src="assets/ptpi.png" alt="PTPI">
                    ...
                    <!-- Slide2 (2 x 3) -->
                    <div class="swiper-slide pb-6">
                        <div class="grid grid-cols-3 grid-rows-2 gap-4 p-4 w-full h-full">
                            <a href="virtual-booth-5.html"
                                class="flex justify-center bg-gray-100 hover:shadow-lg cursor-pointer rounded-xl items-center">
                                <img style="height: 80%;" src="assets/ptpi.png" alt="PTPI">
                            </a>
                            <a href="virtual-booth-5.html"
                                class="flex justify-center bg-gray-100 hover:shadow-lg cursor-pointer rounded-xl items-center">
                                <img style="height: 80%;" src="assets/ptpi.png" alt="PTPI">
                    ...
                    <!-- Slide2 (2 x 4) -->
                    <div class="swiper-slide pb-6">
                        <div class="grid grid-cols-4 grid-rows-2 gap-4 p-4 w-full h-full">
                            <a href="virtual-booth-5.html"
                                class="flex justify-center bg-gray-100 hover:shadow-lg cursor-pointer rounded-xl items-center">
                                <img style="height: 80%;" src="assets/ptpi.png" alt="PTPI">
                            </a>
                ...
                <div class="block swiper-pagination text-left ml-3"></div>
            </div>
        </div>
    </div>

    <div class="filter-box-wrapper rounded-b-md">
        <div x-data="filterExhibitorCategories()" class="filter-box grid grid-cols-4">
            <div class="filter-item"><input class="text-[#00B4BF]" type="checkbox" x-model="selectAll"
                    x-on:change="handleSelectAll()"><label>All</label></div>

            <template x-for="filter in filters" :key="filter.id">
                <div class="filter-item"><input class="text-[#00B4BF]" type="checkbox" :value="filter.id"
                        x-model="filtersSelected" x-on:change="handleChange()"><label x-text="filter.name"></label>
                </div>
            </template>
        </div>
    </div>
