        ...
        <div class="col-span-2 lg:col-span-1 px-4">
            <div class="bg-white py-8 px-6 shadow-lg rounded-lg sm:px-10 max-w-md">
                ...
                <form action="{{ route('login') }}" class="space-y-4" method="POST">
                    ...
                    <div>
                        <button type="submit"
                            class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm font-medium text-white transition-all bg-[#00B4BF] hover:bg-[#116368] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00B4BF]">
                            Login
                        </button>
                    </div>
                </form>
