...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><h5>HOSPITAL ENGINEERING</h5></a>
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Overview - About HEW 2021</h2>
                    <p>Hospital Engineering Week is the first virtual national forum and international fair by
                        Indonesian Association of
                        Hospital Engineering (IAHE) that will be held from 1-3 October 2021. This forum focus on 6
                        hospital engineering areas:
                        Hospital Building, Hospital Mechanic, Hospital Electric, Hospital Environment, Hospital
                        Informatics, and Hospital
                        Devices. More than 40 speakers from government, association, hospital and industries are
                        invited. We also provide more
                        than 100 local and international exhibitors. This event will be co-organised by Karya Indonesia
                        Cerdas.</p>
                </div>
            </div>
        </section>
