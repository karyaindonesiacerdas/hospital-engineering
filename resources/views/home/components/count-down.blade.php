...
<div class="relative bg-gradient-to-b from-[#1DBAC4] to-white pb-10 lg:pb-20 lg:min-h-screen z-0">
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-2 py-3 2xl:py-6 flex flex-col lg:flex-row lg:items-center z-10">
        <div>
            <div class="text-[#063C40] uppercase text-2xl tracking-widest font-semibold text-center md:text-left">
                Virtual
            </div>
            <h2 class="mt-1 text-5xl 2xl:text-6xl text-[#063C40] font-extrabold md:max-w-md text-center md:text-left">
                Hospital
        ...
        <div
            ...
            <a href="#"
                class="bg-white flex flex-col items-center py-2 px-2 md:py-6 md:px-6 rounded-3xl shadow-2xl hover:shadow-none">
                <img class="w-12 md:w-20" src="{{ asset('assets/icons/seminar-rundown.svg') }}" alt="Seminar Rundown">
