    ...
    public function index(Request $request)
    {
        try {
            if (auth()->user()->role == 'admin') {
                $consultations = Consultation::get()->load(['visitor:id,name,institution_name,mobile,referral', 'exhibitor:id,company_name']);
            }
            if (auth()->user()->role == 'visitor') {
                $consultations = auth()->user()->consultations->load(['visitor:id,name,institution_name,mobile,referral', 'exhibitor:id,company_name']);
            }
            if (auth()->user()->role == 'exhibitor') {
                $consultations = auth()->user()->consultations_exhibitor->load(['visitor:id,name,institution_name,mobile,referral', 'exhibitor:id,company_name']);
            }
            if ($request->status) {
